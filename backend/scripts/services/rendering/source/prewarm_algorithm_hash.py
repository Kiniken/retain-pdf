...
SOURCE_CLEANUP_HASH_INPUTS = (
    ...
    "services/rendering/source_cleanup/execution_policy.py",
    "services/rendering/source_cleanup/types.py",
    "services/rendering/source_cleanup/planning/coordinate_resolver.py",
    "services/rendering/source_cleanup/planning/contracts.py",
    ...
    "services/rendering/source_cleanup/policy/adapter.py",
    "services/rendering/source_cleanup/protected_blocks.py",
    "services/rendering/contracts/document_analysis.py",
    "services/rendering/layout/model/render_text.py",
    "services/rendering/layout/payload/render_item.py",
    "services/rendering/layout/payload/text_common.py",
    "services/rendering/policy/cleanup_policy.py",
    "services/rendering/source_cleanup/pdf/document.py",
    "services/rendering/source_cleanup/pdf/path_removal.py",
    "services/rendering/source_cleanup/pdf/hit_test.py",
    "services/rendering/source_cleanup/pdf/stream_engine.py",
    "services/rendering/source_cleanup/pdf/stream_state.py",
    "services/rendering/source_cleanup/pdf/text_removal.py",
    "services/rendering/source_cleanup/pdf/text_ops.py",
