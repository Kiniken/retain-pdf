...
export function normalizeServerFavorite(raw = {}) {
...
export function dedupeServerFavorites(serverFavorites = [], localItems = []) {
...
export function createReaderServerFavoritesPort({
  ...
  async function syncFavorite(quote = {}) {
  ...
  async function removeServerFavorite(favoriteId) {
  ...
  async function recreateFavoriteNote(annotation = {}, note = "") {
