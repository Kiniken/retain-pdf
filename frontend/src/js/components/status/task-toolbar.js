...
class StatusTaskToolbar extends HTMLElement {
  connectedCallback() {
    ...
    if (variant === "downloads") {
      ...
      this.innerHTML = `
        <button id="${STATUS_CARD_IDS.detailButton}" type="button" class="status-action-btn task-toolbar-btn task-toolbar-btn-compact secondary" aria-label="任务详情" title="任务详情">
        ...
        <a id="${STATUS_CARD_IDS.readerButton}" class="status-action-btn secondary disabled task-toolbar-btn task-toolbar-btn-result hidden" href="#" aria-label="对照阅读" title="对照阅读" aria-disabled="true">
          <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <a id="${STATUS_CARD_IDS.pdfButton}" class="status-action-btn secondary disabled task-toolbar-btn task-toolbar-btn-result hidden" href="#" target="_blank" rel="noopener noreferrer" aria-label="下载 PDF" title="下载 PDF">
          <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    this.innerHTML = `
      <button id="${STATUS_CARD_IDS.cancelButton}" type="button" class="status-action-btn task-toolbar-btn secondary" aria-label="取消任务" title="取消任务" disabled>
        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
