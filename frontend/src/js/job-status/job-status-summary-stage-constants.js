...
export const DETAIL_TEXT_MAP = [
  ...
  {
    matches: ["domain_inference", "领域", "术语"],
    detail: "正在识别文档领域和术语",
  },
  {
    matches: ["translation_tail_retry", "tail_retry", "尾部重试"],
    detail: "正在重试剩余翻译批次",
  },
  {
    matches: ["agent_repair", "结果修复"],
    detail: "正在修复翻译结果",
  },
  {
    matches: ["final_untranslated_recovery", "untranslated_recovery", "最终收口"],
    detail: "正在处理未翻译内容",
  },
  {
    matches: ["garbled", "乱码"],
  ...
  {
    matches: ["render_prepare"],
    detail: "正在准备渲染资源",
  },
  {
    matches: ["render_prewarm", "prewarm"],
    detail: "正在预热渲染资源",
  },
  {
    matches: ["render_pages"],
    detail: "正在生成页面内容",
  },
  {
    matches: ["render_compile", "compile"],
    detail: "正在编译 PDF",
  },
  {
...
export const TRANSLATION_SUBTYPE_LABELS = {
  ...
  translation_tail_retry: "尾部重试",
  agent_repair: "结果修复",
  final_untranslated_recovery: "最终收口",
};
