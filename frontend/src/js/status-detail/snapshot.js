...
function stageIconMarkup(job, stageText) {
...
function publicStageForRuntime(job = {}) {
  return job.stage_snapshot?.publicStage || job.display_stage || "";
}

function runtimeStageDetail(presentation = {}) {
  return presentation.detail || presentation.progressText || "";
}

function buildRuntimeDetails(job, eventsPayload, durationOptions = {}) {
