...
// (与 src/pages/reader/components/DownloadToastHost.jsx、
// src/pages/detail/components/DownloadToastHost.jsx 同一模式,home 页缺失该
// 注册导致下载进度提示失效——词表 CSV 导出等下载流程会抛
// "setState is not a function",此处补齐。)
