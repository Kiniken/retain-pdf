...
export function streamMessageText(view, text = "", citations = [], { chunkSize = 3, intervalMs = 12 } = {}) {
  if (!view?.body) {
...
export async function renderRichAnswer(view, text = "", citations = [], { jumpToCitation = null } = {}) {
